...
public class HttpUtil {
    private static org.slf4j.Logger log = LoggerFactory.getLogger(com.example.amisbook002.HttpUtil.class);
    ...
    public static String sendRequest(String requestUrl,
        ...
        try {
            ...
            conn.setRequestProperty("cookie", httpUtil.myCookie);
            conn.connect();
...
//                File("C:\\Users\\59621\\Desktop\\amisbook\\1货物表头\\货物\\发票.xls"));
//        //httpReuqest.sendRequest(requestURL, textMap, requestFile);
//    }
}