...
public class MyAssert {
    //断言方法
    public static void assertIt(String caseID, String actual, String expected) throws UnsupportedEncodingException {
        ...
        if (key.toUpperCase().equals("STRING")) {
            if (actual.contains(myExpected)) {
                ...
                Report.recordResult(a, true, actual);
            } else {
                System.out.println("STRING ++++++ Test Case Fail; 用例编号：" + caseID);
                Report.recordResult(a, false, actual);
            }
